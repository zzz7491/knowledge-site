...
### 1. Android 17 is the first since 3.x to add new APIs without releasing to the AOSP 🔥 热度: 93

📎 [阅读原文](https://grapheneos.social/@GrapheneOS/117282080803799576)

---

### 2. Cloudflare Quick Tunnels 🔥🔥 热度: 402

📎 [阅读原文](https://try.cloudflare.com/)

---

### 3. Saving another 100TB of RAM with math (and Rust) 热度: 42

📎 [阅读原文](https://blog.cloudflare.com/saving-100-tb-of-ram-with-math/)

---

### 4. Apple releases iPhone Duo simulator and Xcode 27.1 beta 热度: 34

📎 [阅读原文](https://developer.apple.com/documentation/xcode-release-notes/xcode-27_1-release-notes)

---

### 5. Photon-Emission-Guided Laser Fault Injection Enables RP2350 Secure Debug 🔥 热度: 105

📎 [阅读原文](https://donjon.ledger.com/blog/rp2350-secure-debug-laser-fault-injection/)

---

### 6. Cache-to-Cache: Direct Semantic Communication Between Large Language Models 热度: 17

📎 [阅读原文](https://arxiv.org/abs/2510.03215)

---

### 7. Show HN: Cactus Needle 3: 8-29MB automation models can match DeepSeek V4 Flash 🔥 热度: 105
