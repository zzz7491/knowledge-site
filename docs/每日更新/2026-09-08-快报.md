...
### 1. 100s of flights cancelled at UK airports due to ATC issue 🔥 热度: 74

📎 [阅读原文](https://www.bbc.com/news/live/c6x2z0yy32ejt)

---

### 2. Google DeepMind Releases AlphaGenome Atlas 🔥🔥 热度: 389

📎 [阅读原文](https://blog.google/innovation-and-ai/models-and-research/google-deepmind/alphagenome-atlas/)

---

### 3. DaVinci Resolve 21.1 🔥🔥 热度: 297

📎 [阅读原文](https://www.blackmagicdesign.com/media/release/20260908-03)

---

### 4. Benchmarking Qwen3.8 27B quantizations: 4-bit holds up, 1-bit collapses 🔥 热度: 158

📎 [阅读原文](https://quesma.com/blog/qwen38-27b-quantizations-benchmarked/)

---

### 5. Muse: Meta's personal AI agent, features and capabilities 🔥 热度: 107

📎 [阅读原文](https://ai.meta.com/muse/)

---

### 6. On the Navier–Stokes Millennium Prize Problem 🔥🔥🔥 热度: 766

📎 [阅读原文](https://openai.com/index/navier-stokes-solution/)

---

### 7. Show HN: LLM Attention Visualization 🔥 热度: 73

📎 [阅读原文](https://ishamf.dev/p/llm-attention-visualizer/)

---

### 8. The Helicopter with Radioactive Blades 🔥 热度: 115

📎 [阅读原文](https://hackaday.com/2026/09/07/the-helicopter-with-radioactive-blades/)
