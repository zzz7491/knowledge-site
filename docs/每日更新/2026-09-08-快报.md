...
### 1. DaVinci Resolve 21.1 🔥 热度: 140

📎 [阅读原文](https://www.blackmagicdesign.com/media/release/20260908-03)

---

### 2. Google DeepMind Releases AlphaGenome Atlas 热度: 38

📎 [阅读原文](https://blog.google/innovation-and-ai/models-and-research/google-deepmind/alphagenome-atlas/)

---

### 3. The two Christian saints who are the Buddha 热度: 28

📎 [阅读原文](https://signoregalilei.com/2026/08/30/the-two-christian-saints-who-are-secretly-the-buddha/)

---

### 4. LibreOffice breaks download records after declaring it has no AI features 🔥🔥 热度: 289

📎 [阅读原文](https://manualdousuario.net/en/libreoffice-download-record-no-ai/)

---

### 5. Show HN: Copperhead – Hardware as Fast as Software 🔥 热度: 88

📎 [阅读原文](https://copperhead.sh/)

---

### 6. ZX Spectrum: Experimenting with 1-Bit Sound 热度: 18

📎 [阅读原文](https://bumbershootsoft.wordpress.com/2026/09/05/zx-spectrum-experimenting-with-1-bit-sound/)

---

### 7. We Must Return to the Office to Use AI in Person 🔥 热度: 197

📎 [阅读原文](https://www.mcsweeneys.net/articles/why-we-must-return-to-the-office-to-use-ai-in-person)

---

### 8. I-have-ADHD: A skill to stop your coding agent from burying the answer 热度: 15

📎 [阅读原文](https://github.com/ayghri/i-have-adhd)
