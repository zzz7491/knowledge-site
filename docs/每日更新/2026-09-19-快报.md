...
### 1. Android 17 is the first since 3.x to add new APIs without releasing to the AOSP 🔥🔥🔥 热度: 534

📎 [阅读原文](https://grapheneos.social/@GrapheneOS/117282080803799576)

---

### 2. Cloudflare Quick Tunnels 🔥🔥🔥 热度: 578

📎 [阅读原文](https://try.cloudflare.com/)

---

### 3. Saving another 100TB of RAM 🔥🔥 热度: 228

📎 [阅读原文](https://blog.cloudflare.com/saving-100-tb-of-ram-with-math/)

---

### 4. The Farnese letter 热度: 27

📎 [阅读原文](https://simonklee.dk/farnese-letter)

---

### 5. Xcode 27.1 Beta Release Notes 🔥 热度: 113

📎 [阅读原文](https://developer.apple.com/documentation/xcode-release-notes/xcode-27_1-release-notes)

---

### 6. How to Write with an LLM 🔥🔥 热度: 391

📎 [阅读原文](https://sockpuppet.org/blog/2026/09/17/how-to-write-with-an-llm/)

---

### 7. Photon-Emission-Guided Laser Fault Injection Enables RP2350 Secure Debug 🔥 热度: 153

📎 [阅读原文](https://donjon.ledger.com/blog/rp2350-secure-debug-laser-fault-injection/)

---

### 8. Show HN: Cactus Needle 3: 8-29MB automation models can match DeepSeek V4 Flash 🔥 热度: 164
