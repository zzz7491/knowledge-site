...
### 1. One Year of Sponsored Servo Development 🔥 热度: 81

📎 [阅读原文](https://servo.org/blog/2026/09/15/one-year-of-sponsorship/)

---

### 2. GLM Built Its Own Inference Infrastructure 热度: 42

📎 [阅读原文](https://z.ai/blog/glm-built-its-inference-infrastructure)

---

### 3. Nvidia announces native GPU programming in Rust 🔥🔥🔥 热度: 704

📎 [阅读原文](https://developer.nvidia.com/blog/introducing-cuda-rust-two-tracks-for-writing-gpu-kernels/)

---

### 4. Keys Not Included: recovering the signing keys for US driver's license barcodes 🔥 热度: 177

📎 [阅读原文](https://ryan.science/blog/keys-not-included)

---

### 5. The Relation Between Mathematics and Physics by Paul Dirac 🔥 热度: 54

📎 [阅读原文](https://www.damtp.cam.ac.uk/events/strings02/dirac/speach.html)

---

### 6. My temporary PHP fix from 2014 has nearly 20M installs. Today I'm deprecating it 🔥 热度: 116

📎 [阅读原文](https://jakeasmith.com/blog/http-build-url/)

---

### 7. Training a 4B model to produce 81% faster query plans than Postgres 🔥🔥🔥 热度: 558

📎 [阅读原文](https://rohanbansal.com/qorl)

---

### 8. Xiaomi Mimo 2.6 live post-training dashboard 🔥🔥 热度: 439
